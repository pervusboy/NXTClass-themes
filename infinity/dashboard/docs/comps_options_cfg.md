...
tool, and use the built in NXTClass editor to crop and edit their image.
...
docs folder:
	...
	nxt-content/themes/child_theme/engine/documents/options/mytheme_option.md

Sub-directories are also allowed:

	nxt-content/themes/child_theme/engine/documents/foo/bar/mytheme_option.md
