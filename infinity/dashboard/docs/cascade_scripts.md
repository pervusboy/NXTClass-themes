...
If your parent theme contains an script under it's script root at:
	...
	nxt-content/themes/parent-theme/assets/scripts/media/lightbox.js

you would have code in your parent theme's functions.php similar to this:

	<?php
		nxt_enqueue_script( 'my-colors', infinity_script_url('media/lightbox.js') );
	?>
...
functionality made my other scripts. Instead, upload a custom lightbox.js here:
	...
	nxt-content/themes/child-theme/content/js/media/lightbox.js

Infinity will traverse the scheme looking for lightbox.js in this manner:

	nxt-content/themes/grandchild-theme/_inc/scripts/media/lightbox.js  < missing
	nxt-content/themes/child-theme/content/js/media/lightbox.js         < found and enqueued
	nxt-content/themes/parent-theme/assets/scripts/media/lightbox.js    < ignored
