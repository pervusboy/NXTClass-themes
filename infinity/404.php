		...
		<article id="post-0" class="post error404 not-found">
			...
			<div class="entry-content">
				<p>
					...
					<?php the_widget( 'nxt_Widget_Recent_Posts', array( 'number' => 10 ), array( 'widget_id' => '404' ) ); ?>	
					...
					<div id="search-categories-widget" class="grid_12 alpha">
						...
						<ul>
						<?php nxt_list_categories( array( 'orderby' => 'count', 'order' => 'DESC', 'show_count' => 1, 'title_li' => '', 'number' => 10 ) ); ?>
						</ul>
					</div>	
					...
					<?php the_widget( 'nxt_Widget_Tag_Cloud' ); ?>
			</div>
		</article>
		<?php
			do_action( 'close_404' );
