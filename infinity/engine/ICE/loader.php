...
final class ICE_Loader extends ICE_Base
{
	...
	/**
	 * Load NXTClass nxt-include files via static call
	 *
	 * @param string $file,... An unlimited number of files to load
	 */
	public function load_nxt_lib()
	{
		foreach( func_get_args() as $file ) {
			require_once( ABSPATH . 'nxt-includes/' . $file . '.php' );
		}
	}

	/**
	 * Load NXTClass nxt-admin/include files via static call
	 *
	 * @param string $file,... An unlimited number of files to load
	 */
	public function load_nxtadmin_lib()
	{
		foreach( func_get_args() as $file ) {
