	 ...
	 extends ICE_Widget
{
	...
	{
		add_action( 'nxt_ajax_ice_widgets_posts_list_save', array( $this, 'ajax_update_hierarchy' ) );
		add_action( 'nxt_ajax_ice_widgets_posts_list_item_status', array( $this, 'ajax_post_status' ) );
		add_action( 'nxt_ajax_ice_widgets_posts_list_item_trash', array( $this, 'ajax_post_trash' ) );
	}
...
class ICE_Posts_List extends nxt_Posts_List_Table
{
	...
	public function __construct( $post_type = 'post' )
	{
		...
		// set this is for nxt_query (yeah, i know)
