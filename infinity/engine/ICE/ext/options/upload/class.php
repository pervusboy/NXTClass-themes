	...
	extends ICE_Option_Image
{
	...
	public function init_ajax()
	{
		...
		add_action( 'nxt_ajax_ice_options_uploader_media_url', array( $this, 'ajax_media_url' ) );
		add_action( 'nxt_ajax_ice_options_uploader_image_edit', array( $this, 'ajax_image_edit' ) );
	}
	...
	protected function localize_script()
	{
		nxt_localize_script(
			...
			array(
				...
				'pp_nxtnonce' => nxt_create_nonce( 'media-form' ),
