...
add_action( 'nxt_loaded', array( 'Infinity_Options_Registry', 'init_form_processing' ) );
...
function infinity_options_render_menu( $args = null )
{
	...
	// parse the args
	$options = (object) nxt_parse_args( $args, $defaults );
...
add_action( 'nxt_ajax_infinity_options_screen', 'infinity_options_render_options_screen' );
