<?php class AdvWidget extends nxt_Widget
{
    function AdvWidget(){
		$widget_ops = array('description' => 'Displays Advertisements');
		$control_ops = array('width' => 400, 'height' => 500);
		parent::nxt_Widget(false,$name='ET Advertisement',$widget_ops,$control_ops);
	}
