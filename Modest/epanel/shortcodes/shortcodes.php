...
add_action('nxt_enqueue_scripts', 'et_shortcodes_css_and_js');
function et_shortcodes_css_and_js(){
	nxt_enqueue_style('et-shortcodes-css', ET_SHORTCODES_DIR . '/shortcodes.css', false, ET_SHORTCODES_VERSION, 'all');
	nxt_enqueue_script('et-shortcodes-js', ET_SHORTCODES_DIR . '/js/et_shortcodes_frontend.js', array('jquery'), ET_SHORTCODES_VERSION, false);
}
...
function et_protected($atts, $content = null){
	...
	if ( is_user_logged_in() ) {
		...
		$output = "<div class='et-protected'>
					...
					<form action='" . home_url() . "/nxt-login.php' method='post'>
				...
				<p class='et-registration'>Not a member? <a href='".site_url('nxt-login.php?action=register', 'login_post')."'>Register today!</a></p>
				</div> <!-- .et-protected -->";
	}
