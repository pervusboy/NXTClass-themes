		...
		<div class="entry clearfix post">	
			...
			<div id="sitemap">
				<div class="sitemap-col">
					...
					<ul id="sitemap-pages"><?php nxt_list_pages('title_li='); ?></ul>
				</div> <!-- end .sitemap-col -->
				
				<div class="sitemap-col">
					<h2><?php esc_html_e('Categories','Modest'); ?></h2>
					<ul id="sitemap-categories"><?php nxt_list_categories('title_li='); ?></ul>
				</div> <!-- end .sitemap-col -->
				...
				<div class="sitemap-col<?php if ($fullwidth) echo ' last'; ?>">
					...
					<ul id="sitemap-authors" ><?php nxt_list_authors('show_fullname=1&optioncount=1&exclude_admin=0'); ?></ul>
				</div> <!-- end .sitemap-col -->
			</div> <!-- end #sitemap -->
