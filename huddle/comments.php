...
<?php if ( have_comments() ) : ?>
	...
	<div class="post-comments" id="comments">
		...
		<ol class="commentlist">
			<?php nxt_list_comments('callback=huddle_comments'); ?>
		</ol>
...
comment_form( array(
	...
	'comment_notes_after'		=>	'',
	'logged_in_as'				=>	'<p class="logged-in-as">' . sprintf( __( 'Logged in as <a href="%1$s">%2$s</a>. <a href="%3$s" title="Log out of this account">Log out?</a>' ), admin_url( 'profile.php' ), $user_identity, nxt_logout_url( apply_filters( 'the_permalink', get_permalink( $post->ID ) ) ) ) . '</p><br />',
