			...
			<div id="item-body" role="main">
				...
				<form action="<?php echo bp_displayed_user_domain() . bp_get_settings_slug() . '/general'; ?>" method="post" class="standard-form" id="settings-form">
					...
					<p class="editfield">
						...
						<input type="password" name="pwd" id="pwd" size="16" value="" class="settings-input small" /> &nbsp;<a href="<?php echo site_url( add_query_arg( array( 'action' => 'lostpassword' ), 'nxt-login.php' ), 'login' ); ?>" title="<?php _e( 'Password Lost and Found', 'huddle' ); ?>"><?php _e( 'Lost your password?', 'huddle' ); ?></a>
					</p>
